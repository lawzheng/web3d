...
})({"i6QNV":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "e4b826c0617d895a";
"use strict";
...
},{}],"fQX5d":[function(require,module,exports) {
...
var _caJpg = require("../assets/imgs/ca.jpg");
var _caJpgDefault = parcelHelpers.interopDefault(_caJpg);
...
const shaderMaterial = new _three.ShaderMaterial({
    ...
    uniforms: {
        ...
        uLowColor: {
            value: new _three.Color(params.uLowColor)
        },
        uHighColor: {
            value: new _three.Color(params.uHighColor)
        },
        uXSpeed: {
...
gui.add(params, "uWareFrequency").min(1).max(100).step(0.1).onChange((value)=>{
...
gui.add(params, "uNoiseScale").min(0).max(10).step(0.001).onChange((value)=>{
...
gui.addColor(params, "uHighColor").onFinishChange((value)=>{
    shaderMaterial.uniforms.uHighColor.value = new _three.Color(value);
});
gui.addColor(params, "uLowColor").onFinishChange((value)=>{
    shaderMaterial.uniforms.uLowColor.value = new _three.Color(value);
});
...
const floor = new _three.Mesh(new _three.PlaneGeometry(1, 1, 1024, 1024), shaderMaterial);
...
},{"three":"ktPTu","three/examples/jsm/controls/OrbitControls":"7mqRv","dat.gui":"k3xQk","../shader/vertex.glsl":"Z5P6P","../shader/fragment.glsl":"fRe8W","../assets/imgs/ca.jpg":"1czTE","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"Z5P6P":[function(require,module,exports) {
...
},{}],"fRe8W":[function(require,module,exports) {
module.exports = "precision lowp float;\n#define GLSLIFY 1\n\nvarying float vElevation;\n\nuniform vec3 uHighColor;\nuniform vec3 uLowColor;\nuniform float uOpacity;\n\nvoid main() {\n  float a = (vElevation + 1.0) / 2.0;\n  vec3 color = mix(uLowColor, uHighColor, a);\n  gl_FragColor = vec4(color,uOpacity);\n}";

},{}],"1czTE":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("jDsZM") + "../ca.9794acac.jpg" + "?" + Date.now();
...
},{}]},["i6QNV","fQX5d"], "fQX5d", "parcelRequire9b34")

//# sourceMappingURL=index.617d895a.js.map
