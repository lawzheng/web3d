...
})({"knVN7":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "fcb006033b5756c5";
"use strict";
...
},{}],"jvCbm":[function(require,module,exports) {
...
const camera = new _three.PerspectiveCamera(75, window.innerWidth / window.innerHeight, 0.1, 30);
...
let cubeArr = [];
let cubeGroup = new _three.Group();
for(let i = 0; i < 5; i++){
...
window.addEventListener("click", (e)=>{
    ...
    for(let i = 0; i < intersects.length; i++)intersects[i].object.material = redMaterial;
});
// 三角形
let triangleGroup = new _three.Group();
for(let i1 = 0; i1 < 50; i1++){
    const geometry = new _three.BufferGeometry();
    const positionArray = new Float32Array(9);
    for(let j1 = 0; j1 < 9; j1++)positionArray[j1] = Math.random() * 10 - 5;
    geometry.setAttribute("position", new _three.BufferAttribute(positionArray, 3));
    const cubeMaterial = new _three.MeshBasicMaterial({
        color: new _three.Color(Math.random(), Math.random(), Math.random()),
        opacity: Math.random(),
        transparent: true,
        side: _three.DoubleSide
    });
    const mesh = new _three.Mesh(geometry, cubeMaterial);
...
const planeGeometry = new _three.PlaneGeometry(20, 20);
const plane = new _three.Mesh(planeGeometry, sphereMaterial);
...
// 聚光灯
const directionalLight = new _three.PointLight("#ff0000", 2);
...
(0, _gsapDefault.default).to(cubeGroup.rotation, {
    x: "+=" + Math.PI,
    y: "+=" + Math.PI,
    duration: 5,
    repeat: -1,
...
(0, _gsapDefault.default).to(triangleGroup.rotation, {
    x: "+=" + Math.PI,
    z: "+=" + Math.PI,
    duration: 6,
    repeat: -1,
...
(0, _gsapDefault.default).to(smallBall.position, {
    x: -3,
    duration: 6,
    repeat: -1,
    ease: "power2.inOut",
...
window.addEventListener("scroll", ()=>{
    ...
    if (newPage !== currentPage) {
        currentPage = newPage;
        (0, _gsapDefault.default).to(arrGroup[currentPage].rotation, {
            z: "+=" + Math.PI,
            x: "+=" + Math.PI,
            duration: 2
        });
        (0, _gsapDefault.default).fromTo(`.page${currentPage + 1} h1`, {
            x: -300
        }, {
            x: 0,
            rotation: "+=360",
...
},{"three":"ktPTu","three/examples/jsm/controls/OrbitControls":"7mqRv","gsap":"fPSuC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fPSuC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"./gsap-core.js":"05eeC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["knVN7","jvCbm"], "jvCbm", "parcelRequire9b34")

//# sourceMappingURL=index.3b5756c5.js.map
