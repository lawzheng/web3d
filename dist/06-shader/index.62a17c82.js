...
})({"1HbrF":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "88133e6d62a17c82";
"use strict";
...
},{}],"88Bz3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _three = require("three");
// 轨道控制器
var _orbitControls = require("three/examples/jsm/controls/OrbitControls");
var _datGui = require("dat.gui");
var _vertexGlsl = require("../shader/deep/vertex.glsl");
var _vertexGlslDefault = parcelHelpers.interopDefault(_vertexGlsl);
var _fragmentGlsl = require("../shader/deep/fragment.glsl");
...
const texture = textureLoader.load((0, _caJpgDefault.default));
...
const floor = new _three.Mesh(new _three.PlaneGeometry(1, 1, 64, 64), rawShaderMaterial);
scene.add(floor);
...
},{"three":"ktPTu","three/examples/jsm/controls/OrbitControls":"7mqRv","dat.gui":"k3xQk","../shader/deep/vertex.glsl":"2VXeq","../shader/deep/fragment.glsl":"cYJW8","../assets/imgs/ca.jpg":"1FVMs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2VXeq":[function(require,module,exports) {
module.exports = "precision lowp float;\n#define GLSLIFY 1\n\nattribute vec3 position;\nattribute vec2 uv;\n\nuniform mat4 projectionMatrix;\nuniform mat4 viewMatrix;\nuniform mat4 modelMatrix;\n\nvarying vec2 vUv;\n\nvoid main() {\n  vec4 modelPosition = modelMatrix * vec4( position, 1.0 );\n  vUv = uv;\n\n  gl_Position = projectionMatrix * viewMatrix * modelPosition;\n}";

},{}],"cYJW8":[function(require,module,exports) {
...
},{}],"1FVMs":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("bGk95") + "../ca.d577e1f0.jpg" + "?" + Date.now();
...
},{}]},["1HbrF","88Bz3"], "88Bz3", "parcelRequire9b34")

//# sourceMappingURL=index.62a17c82.js.map
