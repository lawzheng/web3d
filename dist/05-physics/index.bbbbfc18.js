...
})({"jKCYL":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "ccdfae48bbbbfc18";
"use strict";
...
},{}],"kCSc6":[function(require,module,exports) {
...
scene.add(camera);
const cubeArr = [];
const cubeWorldMaterial = new _cannonEs.Material("cube");
function createCube() {
    const cubeGeometry = new _three.BoxGeometry(1, 1, 1);
    const cubeMaterial = new _three.MeshStandardMaterial();
    const cube = new _three.Mesh(cubeGeometry, cubeMaterial);
    cube.castShadow = true;
    scene.add(cube);
    // 创建物理小球
    const cubeShape = new _cannonEs.Box(new _cannonEs.Vec3(0.5, 0.5, 0.5));
    // 创建物理世界的物体
    const cubeBody = new _cannonEs.Body({
        shape: cubeShape,
        position: new _cannonEs.Vec3(0, 0, 0),
        // 质量
        mass: 1,
        // 材质
    ...
    // 施加外力
    cubeBody.applyLocalForce(// 外力放心
    new _cannonEs.Vec3(300, 0, 0), // 作用位置
    new _cannonEs.Vec3(0, 0, 0));
    // 物体添加到物理世界
...
const floor = new _three.Mesh(new _three.PlaneGeometry(20, 20), new _three.MeshStandardMaterial());
...
const dirLight = new _three.DirectionalLight(0xffffff, 0.5);
...
const floorMaterial = new _cannonEs.Material("floor");
floorBody.material = floorMaterial;
const defaultContactMaterial = new _cannonEs.ContactMaterial(cubeWorldMaterial, floorMaterial, {
    // 摩擦力
    friction: 0.1,
    // 弹性
    restitution: 0.7
...
},{"three":"ktPTu","three/examples/jsm/controls/OrbitControls":"7mqRv","dat.gui":"k3xQk","cannon-es":"HCu3b"}],"HCu3b":[function(require,module,exports) {
/**
...
parcelHelpers.export(exports, "BODY_SLEEP_STATES", ()=>BODY_SLEEP_STATES);
parcelHelpers.export(exports, "BODY_TYPES", ()=>BODY_TYPES);
parcelHelpers.export(exports, "Body", ()=>Body);
parcelHelpers.export(exports, "Box", ()=>Box);
parcelHelpers.export(exports, "Broadphase", ()=>Broadphase);
parcelHelpers.export(exports, "COLLISION_TYPES", ()=>COLLISION_TYPES);
parcelHelpers.export(exports, "ConeTwistConstraint", ()=>ConeTwistConstraint);
parcelHelpers.export(exports, "Constraint", ()=>Constraint);
parcelHelpers.export(exports, "ContactEquation", ()=>ContactEquation);
parcelHelpers.export(exports, "ContactMaterial", ()=>ContactMaterial);
parcelHelpers.export(exports, "ConvexPolyhedron", ()=>ConvexPolyhedron);
parcelHelpers.export(exports, "Cylinder", ()=>Cylinder);
parcelHelpers.export(exports, "DistanceConstraint", ()=>DistanceConstraint);
parcelHelpers.export(exports, "Equation", ()=>Equation);
parcelHelpers.export(exports, "EventTarget", ()=>EventTarget);
parcelHelpers.export(exports, "FrictionEquation", ()=>FrictionEquation);
parcelHelpers.export(exports, "GSSolver", ()=>GSSolver);
parcelHelpers.export(exports, "GridBroadphase", ()=>GridBroadphase);
parcelHelpers.export(exports, "Heightfield", ()=>Heightfield);
parcelHelpers.export(exports, "HingeConstraint", ()=>HingeConstraint);
parcelHelpers.export(exports, "JacobianElement", ()=>JacobianElement);
parcelHelpers.export(exports, "LockConstraint", ()=>LockConstraint);
parcelHelpers.export(exports, "Mat3", ()=>Mat3);
parcelHelpers.export(exports, "Material", ()=>Material);
parcelHelpers.export(exports, "NaiveBroadphase", ()=>NaiveBroadphase);
parcelHelpers.export(exports, "Narrowphase", ()=>Narrowphase);
parcelHelpers.export(exports, "ObjectCollisionMatrix", ()=>ObjectCollisionMatrix);
parcelHelpers.export(exports, "Particle", ()=>Particle);
parcelHelpers.export(exports, "Plane", ()=>Plane);
parcelHelpers.export(exports, "PointToPointConstraint", ()=>PointToPointConstraint);
parcelHelpers.export(exports, "Pool", ()=>Pool);
parcelHelpers.export(exports, "Quaternion", ()=>Quaternion);
parcelHelpers.export(exports, "RAY_MODES", ()=>RAY_MODES);
parcelHelpers.export(exports, "Ray", ()=>Ray);
parcelHelpers.export(exports, "RaycastResult", ()=>RaycastResult);
parcelHelpers.export(exports, "RaycastVehicle", ()=>RaycastVehicle);
parcelHelpers.export(exports, "RigidVehicle", ()=>RigidVehicle);
parcelHelpers.export(exports, "RotationalEquation", ()=>RotationalEquation);
parcelHelpers.export(exports, "RotationalMotorEquation", ()=>RotationalMotorEquation);
parcelHelpers.export(exports, "SAPBroadphase", ()=>SAPBroadphase);
parcelHelpers.export(exports, "SHAPE_TYPES", ()=>SHAPE_TYPES);
parcelHelpers.export(exports, "SPHSystem", ()=>SPHSystem);
...
parcelHelpers.export(exports, "SplitSolver", ()=>SplitSolver);
 ...
 */ class Mat3 {
   ...
   */ solve(b, target) {
        ...
        eqns[3] = b.x;
        eqns[7] = b.y;
        eqns[11] = b.z; // Compute right upper triangular version of the matrix - Gauss elimination
        let n = 3;
        const k = n;
        let np;
        const kp = 4; // num rows
   ...
   */ e(row, column, value) {
        if (value === undefined) return this.elements[column + 3 * row];
        else // Set value
   ...
   */ reverse(target) {
        ...
        eqns[5] = 0;
        eqns[11] = 0;
        eqns[17] = 1; // Compute right upper triangular version of the matrix - Gauss elimination
        let n = 3;
        const k = n;
        let np;
        ...
        do {
            j = i - 1;
            do {
                const multiplier1 = eqns[i + nc * j] / eqns[i + nc * i];
                np = nc;
                do {
                    p = nc - np;
                    eqns[p + nc * j] = eqns[p + nc * j] - eqns[p + nc * i] * multiplier1;
                }while (--np);
            }while (j--);
        }while (--i); // operations on the diagonal
        i = 2;
        do {
            const multiplier2 = 1 / eqns[i + nc * i];
            np = nc;
            do {
                p = nc - np;
                eqns[p + nc * i] = eqns[p + nc * i] * multiplier2;
            }while (--np);
        }while (i--);
        i = 2;
        do {
 ...
 */ class EventTarget {
   ...
   */ hasEventListener(type, listener) {
        ...
        const listeners = this._listeners;
        if (listeners[type] !== undefined && listeners[type].includes(listener)) return true;
        return false;
    }
    /**
 ...
 */ class ConvexPolyhedron extends Shape {
   ...
   */ computeNormals() {
        ...
        for(let i = 0; i < this.faces.length; i++){
            ...
            if (n.dot(vertex) < 0) {
                ...
                for(let j1 = 0; j1 < this.faces[i].length; j1++)console.warn(`.vertices[${this.faces[i][j1]}] = Vec3(${this.vertices[this.faces[i][j1]].toString()})`);
            }
        }
    }
    /**
   ...
   */ findSeparatingAxis(hullB, posA, quatA, posB, quatB, target, faceListA, faceListB) {
        ...
        for(let i1 = 0; i1 !== hullA.uniqueAxes.length; i1++){
            // Get world axis
            quatA.vmult(hullA.uniqueAxes[i1], faceANormalWS3);
            const d1 = hullA.testSepAxis(faceANormalWS3, hullB, posA, quatA, posB, quatB);
        ...
        if (!hullB.uniqueAxes) {
            ...
            for(let i2 = 0; i2 < numFacesB; i2++){
                const fi1 = faceListB ? faceListB[i2] : i2;
                Worldnormal1.copy(hullB.faceNormals[fi1]);
                quatB.vmult(Worldnormal1, Worldnormal1);
                const d2 = hullA.testSepAxis(Worldnormal1, hullB, posA, quatA, posB, quatB);
        ...
        for(let i3 = 0; i3 !== hullB.uniqueAxes.length; i3++){
            ...
            const d3 = hullA.testSepAxis(Worldnormal1, hullB, posA, quatA, posB, quatB);
            if (d3 === false) return false;
            if (d3 < dmin) {
                dmin = d3;
                target.copy(Worldnormal1);
            }
        ...
        if (deltaC.dot(target) > 0.0) target.negate(target);
        return true;
    }
    /**
   ...
   */ clipFaceAgainstHull(separatingNormal, posA, quatA, worldVertsB1, minDist, maxDist, result) {
        ...
        for(let i = 0; i < hullA.faces.length; i++){
            for(let j = 0; j < hullA.faces[i].length; j++)if (/* Sharing a vertex*/ polyA.indexOf(hullA.faces[i][j]) !== -1 && /* Not the one we are looking for connections from */ i !== closestFaceA && /* Not already added */ polyA.connectedFaces.indexOf(i) === -1) polyA.connectedFaces.push(i);
        } // Clip the polygon to the back of the planes of all faces of hull A,
        // that are adjacent to the witness face
        const numVerticesA = polyA.length;
        for(let i1 = 0; i1 < numVerticesA; i1++){
            const a = hullA.vertices[polyA[i1]];
            const b = hullA.vertices[polyA[(i1 + 1) % numVerticesA]];
            a.vsub(b, edge0);
            ...
            const otherFace = polyA.connectedFaces[i1];
        ...
        const localPlaneEq1 = this.getPlaneConstantOfFace(closestFaceA);
        planeNormalWS.copy(localPlaneNormal);
        quatA.vmult(planeNormalWS, planeNormalWS);
        const planeEqWS1 = localPlaneEq1 - planeNormalWS.dot(posA);
        for(let i2 = 0; i2 < pVtxIn.length; i2++){
            let depth = planeNormalWS.dot(pVtxIn[i2]) + planeEqWS1; // ???
            if (depth <= minDist) {
        ...
        for(let vi = 0; vi < numVerts; vi++){
            ...
            if (n_dot_first < 0) {
                if (n_dot_last < 0) {
                    ...
                    const newv1 = new Vec3();
                    firstVertex.lerp(lastVertex, n_dot_first / (n_dot_first - n_dot_last), newv1);
                    outVertices.push(newv1);
                }
            } else if (n_dot_last < 0) {
                // Start >= 0, end < 0 so output intersection and end
                const newv2 = new Vec3();
                firstVertex.lerp(lastVertex, n_dot_first / (n_dot_first - n_dot_last), newv2);
                outVertices.push(newv2);
   ...
   */ calculateWorldAABB(pos, quat, min, max) {
        ...
        for(let i = 0; i < verts.length; i++){
            ...
            if (minz === undefined || v.z < minz) minz = v.z;
            if (maxz === undefined || v.z > maxz) maxz = v.z;
        }
   ...
   */ transformAllPoints(offset, quat) {
        ...
        if (quat) {
            ...
            for(let i1 = 0; i1 < this.faceNormals.length; i1++){
                const v1 = this.faceNormals[i1];
                quat.vmult(v1, v1);
            }
        /*
            // Rotate edges
        ...
        if (offset) for(let i2 = 0; i2 < n; i2++){
            const v2 = verts[i2];
            v2.vadd(offset, v2);
        }
    }
   ...
   */ pointIsInside(p) {
        ...
        for(let i = 0; i < this.faces.length; i++){
            ...
            if (r1 < 0 && r2 > 0 || r1 > 0 && r2 < 0) return false; // Encountered some other sign. Exit.
 ...
 */ class Box extends Shape {
   ...
   */ getSideNormals(sixTargetVectors, quat) {
        ...
        if (quat !== undefined) for(let i = 0; i !== sides.length; i++)quat.vmult(sides[i], sides[i]);
        return sides;
    }
    /**
 ...
 */ class Body extends EventTarget {
   ...
   */ sleepTick(time) {
        if (this.allowSleep) {
            ...
            } else if (sleepState === Body.SLEEPY && speedSquared > speedLimitSquared) this.wakeUp(); // Wake up
   ...
   */ integrate(dt, quatNormalize, quatNormalizeFast) {
        ...
        if (quatNormalize) {
            if (quatNormalizeFast) quat.normalizeFast();
            else quat.normalize();
        }
 ...
 */ class Broadphase {
   ...
   */ makePairsUnique(pairs1, pairs2) {
        ...
        for(let i2 = 0; i2 !== t.keys.length; i2++){
            const key1 = t.keys.pop();
            const pairIndex = t[key1];
   ...
   */ collisionPairs(world, pairs1, pairs2) {
        ...
        function addBoxToBins(x0, y0, z0, x1, y1, z1, bi) {
            ...
            for(let xoff = xoff0; xoff <= xoff1; xoff += xstep){
                for(let yoff = yoff0; yoff <= yoff1; yoff += ystep)for(let zoff = zoff0; zoff <= zoff1; zoff += zstep){
        ...
        for(let i1 = 0; i1 !== N; i1++){
            ...
            switch(si.type){
                ...
                case PLANE:
                    {
                        const shape1 = si;
                        if (shape1.worldNormalNeedsUpdate) shape1.computeWorldNormal(bi.quaternion);
                        const planeNormal = shape1.worldNormal; //Relative position from origin of plane object to the first bin
                        ...
                        for(let xi = 0, xoff = 0; xi !== nx; xi++, xoff += xstep, d.y = yreset, d.x += binsizeX)for(let yi = 0, yoff = 0; yi !== ny; yi++, yoff += ystep, d.z = zreset, d.y += binsizeY){
        ...
        for(let i2 = 0; i2 !== Nbins; i2++){
            const binLength = binLengths[i2]; //Skip bins with no potential collisions
            if (binLength > 1) {
                const bin = bins[i2]; // Do N^2 broadphase inside
                for(let xi1 = 0; xi1 !== binLength; xi1++){
                    const bi1 = bin[xi1];
                    for(let yi1 = 0; yi1 !== xi1; yi1++){
                        const bj = bin[yi1];
                        if (this.needBroadphaseCollision(bi1, bj)) this.intersectionTest(bi1, bj, pairs1, pairs2);
                    }
                }
            }
 ...
 */ class Ray {
   ...
   */ intersectBody(body, result) {
        ...
        for(let i = 0, N = body.shapes.length; i < N; i++){
            ...
            if (checkCollisionResponse && !shape.collisionResponse) continue; // Skip
 ...
 */ class SAPBroadphase extends Broadphase {
   ...
   */ autoDetectAxis() {
        ...
        if (varianceX > varianceY) {
            if (varianceX > varianceZ) this.axisIndex = 0;
 ...
 */ class Equation {
   ...
   */ constructor(bi, bj, minForce, maxForce){
        if (minForce === void 0) minForce = -1000000;
   ...
   */ getVehicleAxisWorld(axisIndex, result) {
    ...
    updateVehicle(timeStep) {
        ...
        if (forwardWorld.dot(chassisBody.velocity) < 0) this.currentVehicleSpeedKmHour *= -1;
         // simulate suspension
        for(let i1 = 0; i1 < numWheels; i1++)this.castRay(wheelInfos[i1]);
        this.updateSuspension(timeStep);
        const impulse = new Vec3();
        const relpos = new Vec3();
        for(let i2 = 0; i2 < numWheels; i2++){
            //apply suspension force
            const wheel = wheelInfos[i2];
        ...
        const fwd = new Vec3();
        const vel = new Vec3();
        for(let i3 = 0; i3 < numWheels; i3++){
            const wheel1 = wheelInfos[i3]; //const relpos = new Vec3();
            //wheel.chassisConnectionPointWorld.vsub(chassisBody.position, relpos);
            chassisBody.getVelocityAtWorldPoint(wheel1.chassisConnectionPointWorld, vel); // Hack to get the rotation in the correct direction
            let m = 1;
            ...
            if (wheel1.isInContact) {
                this.getVehicleAxisWorld(this.indexForwardAxis, fwd);
                const proj = fwd.dot(wheel1.raycastResult.hitNormalWorld);
                wheel1.raycastResult.hitNormalWorld.scale(proj, hitNormalWorldScaledWithProj);
                fwd.vsub(hitNormalWorldScaledWithProj, fwd);
                const proj2 = fwd.dot(vel);
                wheel1.deltaRotation = m * proj2 * timeStep / wheel1.radius;
            }
            if ((wheel1.sliding || !wheel1.isInContact) && wheel1.engineForce !== 0 && wheel1.useCustomSlidingRotationalSpeed) // Apply custom rotation when accelerating and sliding
            wheel1.deltaRotation = (wheel1.engineForce > 0 ? 1 : -1) * wheel1.customSlidingRotationalSpeed * timeStep;
             // Lock wheels
            if (Math.abs(wheel1.brake) > Math.abs(wheel1.engineForce)) wheel1.deltaRotation = 0;
            wheel1.rotation += wheel1.deltaRotation; // Use the old value
            wheel1.deltaRotation *= 0.99; // damping of rotation when not in contact
        }
    }
   ...
   */ getWheelTransformWorld(wheelIndex) {
    ...
    updateFriction(timeStep) {
        ...
        for(let i = 0; i < numWheels; i++){
            ...
            if (groundObject) this.numWheelsOnGround++;
            wheel.sideImpulse = 0;
            wheel.forwardImpulse = 0;
            if (!forwardWS[i]) forwardWS[i] = new Vec3();
            if (!axle[i]) axle[i] = new Vec3();
        }
        for(let i1 = 0; i1 < numWheels; i1++){
            const wheel1 = wheelInfos[i1];
            const groundObject1 = wheel1.raycastResult.body;
            if (groundObject1) {
                const axlei = axle[i1];
                const wheelTrans = this.getWheelTransformWorld(i1); // Get world axle
                wheelTrans.vectorToWorldFrame(directions[this.indexRightAxis], axlei);
                const surfNormalWS = wheel1.raycastResult.hitNormalWorld;
                const proj = axlei.dot(surfNormalWS);
                surfNormalWS.scale(proj, surfNormalWS_scaled_proj);
                axlei.vsub(surfNormalWS_scaled_proj, axlei);
                axlei.normalize();
                surfNormalWS.cross(axlei, forwardWS[i1]);
                forwardWS[i1].normalize();
                wheel1.sideImpulse = resolveSingleBilateral(chassisBody, wheel1.raycastResult.hitPointWorld, groundObject1, wheel1.raycastResult.hitPointWorld, axlei);
                wheel1.sideImpulse *= sideFrictionStiffness2;
            }
        }
        const sideFactor = 1;
        const fwdFactor = 0.5;
        this.sliding = false;
        for(let i2 = 0; i2 < numWheels; i2++){
            const wheel2 = wheelInfos[i2];
            const groundObject2 = wheel2.raycastResult.body;
            let rollingFriction = 0;
            wheel2.slipInfo = 1;
            if (groundObject2) {
                const defaultRollingFrictionImpulse = 0;
                const maxImpulse = wheel2.brake ? wheel2.brake : defaultRollingFrictionImpulse; // btWheelContactPoint contactPt(chassisBody,groundObject,wheelInfraycastInfo.hitPointWorld,forwardWS[wheel],maxImpulse);
                // rollingFriction = calcRollingFriction(contactPt);
                rollingFriction = calcRollingFriction(chassisBody, groundObject2, wheel2.raycastResult.hitPointWorld, forwardWS[i2], maxImpulse);
                rollingFriction += wheel2.engineForce * timeStep; // rollingFriction = 0;
                const factor = maxImpulse / rollingFriction;
                wheel2.slipInfo *= factor;
            } //switch between active rolling (throttle), braking and non-active rolling friction (nthrottle/break)
            wheel2.forwardImpulse = 0;
            wheel2.skidInfo = 1;
            if (groundObject2) {
                wheel2.skidInfo = 1;
                const maximp = wheel2.suspensionForce * timeStep * wheel2.frictionSlip;
                const maximpSide = maximp;
                const maximpSquared = maximp * maximpSide;
                wheel2.forwardImpulse = rollingFriction; //wheelInfo.engineForce* timeStep;
                const x = wheel2.forwardImpulse * fwdFactor / wheel2.forwardAcceleration;
                const y = wheel2.sideImpulse * sideFactor / wheel2.sideAcceleration;
                const impulseSquared = x * x + y * y;
                wheel2.sliding = false;
                if (impulseSquared > maximpSquared) {
                    this.sliding = true;
                    wheel2.sliding = true;
                    const factor1 = maximp / Math.sqrt(impulseSquared);
                    wheel2.skidInfo *= factor1;
                }
            }
        }
        if (this.sliding) for(let i3 = 0; i3 < numWheels; i3++){
            const wheel3 = wheelInfos[i3];
            if (wheel3.sideImpulse !== 0) {
                if (wheel3.skidInfo < 1) {
                    wheel3.forwardImpulse *= wheel3.skidInfo;
                    wheel3.sideImpulse *= wheel3.skidInfo;
                }
            }
        }
         // apply the impulses
        for(let i4 = 0; i4 < numWheels; i4++){
            const wheel4 = wheelInfos[i4];
            const rel_pos = new Vec3();
            wheel4.raycastResult.hitPointWorld.vsub(chassisBody.position, rel_pos); // cannons applyimpulse is using world coord for the position
            //rel_pos.copy(wheel.raycastResult.hitPointWorld);
            if (wheel4.forwardImpulse !== 0) {
                const impulse = new Vec3();
                forwardWS[i4].scale(wheel4.forwardImpulse, impulse);
                chassisBody.applyImpulse(impulse, rel_pos);
            }
            if (wheel4.sideImpulse !== 0) {
                const groundObject3 = wheel4.raycastResult.body;
                const rel_pos2 = new Vec3();
                wheel4.raycastResult.hitPointWorld.vsub(groundObject3.position, rel_pos2); //rel_pos2.copy(wheel.raycastResult.hitPointWorld);
                const sideImp = new Vec3();
                axle[i4].scale(wheel4.sideImpulse, sideImp); // Scale the relative position in the up direction with rollInfluence.
                // If rollInfluence is 1, the impulse will be applied on the hitPoint (easy to roll over), if it is zero it will be applied in the same plane as the center of mass (not easy to roll over).
                chassisBody.vectorToLocalFrame(rel_pos, rel_pos);
                rel_pos["xyz"[this.indexUpAxis]] *= wheel4.rollInfluence;
                chassisBody.vectorToWorldFrame(rel_pos, rel_pos);
                chassisBody.applyImpulse(sideImp, rel_pos); //apply friction impulse on the ground
                sideImp.scale(-1, sideImp);
                groundObject3.applyImpulse(sideImp, rel_pos2);
            }
        }
    }
}
...
function resolveSingleBilateral(body1, pos1, body2, pos2, normal) {
    ...
    if (normalLenSqr > 1.1) return 0; // no impulse
 ...
 */ class RigidVehicle {
   ...
   */ constructor(options){
        ...
        else // No chassis body given. Create it!
   ...
   */ addWheel(options) {
        ...
        else // No wheel body given. Create it!
        wheelBody = new Body({
            mass: 1,
   ...
   */ addToWorld(world) {
        ...
        for(let i1 = 0; i1 < constraints.length; i1++)world.addConstraint(constraints[i1]);
   ...
   */ removeFromWorld(world) {
        ...
        for(let i1 = 0; i1 < constraints.length; i1++)world.removeConstraint(constraints[i1]);
    }
    /**
 ...
 */ class SPHSystem {
   ...
   */ getNeighbors(particle, neighbors) {
    ...
    update() {
        ...
        for(let i1 = 0; i1 !== N; i1++){
            const particle = this.particles[i1];
            a_pressure.set(0, 0, 0);
            a_visc.set(0, 0, 0); // Init vars
            let Pij;
            let nabla;
            const neighbors1 = this.neighbors[i1];
            const numNeighbors1 = neighbors1.length; //printf("Neighbors: ");
            for(let j1 = 0; j1 !== numNeighbors1; j1++){
                const neighbor = neighbors1[j1]; //printf("%d ",nj);
                // Get r once for all..
                particle.position.vsub(neighbor.position, r_vec);
                const r = r_vec.length(); // Pressure contribution
                Pij = -neighbor.mass * (this.pressures[i1] / (this.densities[i1] * this.densities[i1] + eps) + this.pressures[j1] / (this.densities[j1] * this.densities[j1] + eps));
                ...
                u.scale(1.0 / (0.0001 + this.densities[i1] * this.densities[j1]) * this.viscosity * neighbor.mass, u);
                nabla = this.nablaw(r);
 ...
 */ class Cylinder extends ConvexPolyhedron {
   ...
   */ constructor(radiusTop, radiusBottom, height, numSegments){
        ...
        const temp = [];
        for(let i1 = 0; i1 < topface.length; i1++)temp.push(topface[topface.length - i1 - 1]);
        faces.push(temp);
        super({
            vertices,
            faces,
 ...
 */ class Heightfield extends Shape {
   ...
   */ getHeightAt(x, y, edgeClamp) {
        ...
        if (upper) // Top triangle verts
        return data[xi + 1][yi + 1] * w.x + data[xi][yi + 1] * w.y + data[xi + 1][yi] * w.z;
        else // Top triangle verts
   ...
   */ getConvexTrianglePillar(xi, yi, getUpperTriangle) {
        ...
        faces.length = 5;
        for(let i1 = 0; i1 < 5; i1++)if (!faces[i1]) faces[i1] = [];
        const verts = result.vertices;
        const h = (Math.min(data1[xi][yi], data1[xi + 1][yi], data1[xi][yi + 1], data1[xi + 1][yi + 1]) - this.minValue) / 2 + this.minValue;
        if (!getUpperTriangle) {
            // Center of the triangle pillar - all polygons are given relative to this one
            offsetResult.set((xi + 0.25) * elementSize, (yi + 0.25) * elementSize, h // vertical center
            ); // Top triangle verts
            verts[0].set(-0.25 * elementSize, -0.25 * elementSize, data1[xi][yi] - h);
            verts[1].set(0.75 * elementSize, -0.25 * elementSize, data1[xi + 1][yi] - h);
            verts[2].set(-0.25 * elementSize, 0.75 * elementSize, data1[xi][yi + 1] - h); // bottom triangle verts
            ...
            verts[0].set(0.25 * elementSize, 0.25 * elementSize, data1[xi + 1][yi + 1] - h);
            verts[1].set(-0.75 * elementSize, 0.25 * elementSize, data1[xi][yi + 1] - h);
            verts[2].set(0.25 * elementSize, -0.75 * elementSize, data1[xi + 1][yi] - h); // bottom triangle verts
            verts[3].set(0.25 * elementSize, 0.25 * elementSize, -Math.abs(h) - 1);
            verts[4].set(-0.75 * elementSize, 0.25 * elementSize, -Math.abs(h) - 1);
            verts[5].set(0.25 * elementSize, -0.75 * elementSize, -Math.abs(h) - 1); // Top triangle
            faces[0][0] = 0;
 ...
 */ class OctreeNode {
   ...
   */ insert(aabb, elementData, level) {
        ...
        if (!this.aabb.contains(aabb)) return false; // object cannot be added
        ...
        if (level < maxDepth) {
            ...
            if (subdivided) // No children accepted! Might as well just remove em since they contain none
            children.length = 0;
 ...
 */ class Trimesh extends Shape {
   ...
   */ setScale(scale) {
        ...
        if (!(wasUniform && isUniform)) // Non-uniform scaling. Need to update normals.
        this.updateNormals();
   ...
   */ updateEdges() {
        ...
        for(let i1 = 0; i1 < keys.length; i1++){
            const indices = keys[i1].split("_");
            this.edges[2 * i1] = parseInt(indices[0], 10);
            this.edges[2 * i1 + 1] = parseInt(indices[1], 10);
        }
    }
    /**
   * Get an edge vertex
   ...
   */ static createTorus(radius, tube, radialSegments, tubularSegments, arc) {
        ...
        for(let j1 = 1; j1 <= radialSegments; j1++)for(let i1 = 1; i1 <= tubularSegments; i1++){
 ...
 */ class GSSolver extends Solver {
   ...
   */ solve(dt, world) {
        ...
        Bs.length = Neq;
        lambda.length = Neq;
        for(let i1 = 0; i1 !== Neq; i1++){
            const c = equations[i1];
            lambda[i1] = 0.0;
            Bs[i1] = c.computeB(h);
            invCs[i1] = 1.0 / c.computeC();
        }
        if (Neq !== 0) {
            // Reset vlambda
            ...
            for(iter = 0; iter !== maxIter; iter++){
                ...
                deltalambdaTot = 0.0;
                for(let j = 0; j !== Neq; j++){
                    const c1 = equations[j]; // Compute iteration
                    B = Bs[j];
                    invC = invCs[j];
                    lambdaj = lambda[j];
                    GWlambda = c1.computeGWlambda();
                    deltalambda = invC * (B - GWlambda - c1.eps * lambdaj); // Clamp if we are not within the min/max interval
                    if (lambdaj + deltalambda < c1.minForce) deltalambda = c1.minForce - lambdaj;
                    else if (lambdaj + deltalambda > c1.maxForce) deltalambda = c1.maxForce - lambdaj;
                    lambda[j] += deltalambda;
                    deltalambdaTot += deltalambda > 0.0 ? deltalambda : -deltalambda; // abs(deltalambda)
                    c1.addToWlambda(deltalambda);
            ...
            for(let i3 = 0; i3 !== Nbodies; i3++){
                const b1 = bodies[i3];
                const v = b1.velocity;
                const w = b1.angularVelocity;
                b1.vlambda.vmul(b1.linearFactor, b1.vlambda);
                v.vadd(b1.vlambda, v);
                b1.wlambda.vmul(b1.angularFactor, b1.wlambda);
                w.vadd(b1.wlambda, w);
 ...
 */ class SplitSolver extends Solver {
   ...
   */ solve(dt, world) {
        ...
        while(child = getUnvisitedNode(nodes)){
            ...
            for(let i3 = 0; i3 !== Neqs; i3++)subsolver.addEquation(eqs[i3]);
 ...
 */ class Pool {
   ...
   */ release() {
        ...
        for(let i = 0; i !== Nargs; i++)this.objects.push(i < 0 || arguments.length <= i ? undefined : arguments[i]);
        return this;
    }
    /**
   * Get an object
   ...
   */ getContacts(p1, p2, world, result, oldcontacts, frictionResult, frictionPool) {
    ...
    sphereBox(si, sj, xi, xj, qi, qj, bi, bj, rsi, rsj, justTest) {
        ...
        for(let j = 0; j !== 2 && !found; j++){
            for(let k = 0; k !== 2 && !found; k++)for(let l = 0; l !== 2 && !found; l++){
                rj.set(0, 0, 0);
                ...
                if (sphere_to_corner.lengthSquared() < R * R) {
                    ...
                    r1.ni.copy(r1.ri);
                    r1.ri.scale(R, r1.ri);
                    r1.rj.copy(rj); // Make relative to bodies
                    r1.ri.vadd(xi, r1.ri);
        ...
        const r2 = v3pool.get(); // r = edge center to sphere center
        const orthogonal = v3pool.get();
        const dist1 = v3pool.get();
        const Nsides = sides.length;
        for(let j1 = 0; j1 !== Nsides && !found; j1++){
            for(let k1 = 0; k1 !== Nsides && !found; k1++)if (j1 % 3 !== k1 % 3) {
                // Get edge tangent
                sides[k1].cross(sides[j1], edgeTangent);
                edgeTangent.normalize();
                sides[j1].vadd(sides[k1], edgeCenter);
                r2.copy(xi);
                r2.vsub(edgeCenter, r2);
                r2.vsub(xj, r2);
                const orthonorm = r2.dot(edgeTangent); // distance from edge center to sphere center in the tangent direction
                edgeTangent.scale(orthonorm, orthogonal); // Vector from edge center to sphere center in the tangent direction
                // Find the third side orthogonal to this one
                let l1 = 0;
                while(l1 === j1 % 3 || l1 === k1 % 3)l1++;
                 // vec from edge center to sphere projected to the plane orthogonal to the edge tangent
                dist1.copy(xi);
                dist1.vsub(orthogonal, dist1);
                dist1.vsub(edgeCenter, dist1);
                dist1.vsub(xj, dist1); // Distances in tangent direction and distance in the plane orthogonal to it
                const tdist = Math.abs(orthonorm);
                const ndist = dist1.length();
                if (tdist < sides[l1].length() && ndist < R) {
                    if (justTest) return true;
                    found = true;
        ...
        v3pool.release(edgeTangent, edgeCenter, r2, orthogonal, dist1);
    }
    ...
    sphereConvex(si, sj, xi, xj, qi, qj, bi, bj, rsi, rsj, justTest) {
        ...
        for(let i1 = 0, nfaces = faces.length; i1 !== nfaces && found === false; i1++){
            const normal = normals[i1];
            const face = faces[i1]; // Get world-transformed normal of the face
            ...
            if (penetration < 0 && worldPointToSphere.dot(worldNormal) > 0) {
                ...
                if (pointInPolygon(faceVerts, worldNormal, xi)) {
                    ...
                    found = true;
                    const r1 = this.createContactEquation(bi, bj, si, sj, rsi, rsj);
                    worldNormal.scale(-R, r1.ri); // Contact offset, from sphere center to contact
                    worldNormal.negate(r1.ni); // Normal pointing out of sphere
                    ...
                    xi.vsub(xj, r1.rj);
                    r1.rj.vadd(penetrationSpherePoint, r1.rj);
                    r1.rj.vadd(penetrationVec2, r1.rj); // Should be relative to the body.
                    r1.rj.vadd(xj, r1.rj);
                    r1.rj.vsub(bj.position, r1.rj); // Should be relative to the body.
                    r1.ri.vadd(xi, r1.ri);
                    r1.ri.vsub(bi.position, r1.ri);
                    v3pool.release(penetrationVec2);
                    v3pool.release(penetrationSpherePoint);
                    this.result.push(r1);
                    this.createFrictionEquationsFromContact(r1, this.frictionResult); // Release world vertices
                    for(let j1 = 0, Nfaceverts = faceVerts.length; j1 !== Nfaceverts; j1++)v3pool.release(faceVerts[j1]);
                ...
                for(let j2 = 0; j2 !== face.length; j2++){
                    ...
                    const v1 = v3pool.get();
                    const v2 = v3pool.get();
                    qj.vmult(verts[face[(j2 + 1) % face.length]], v1);
                    qj.vmult(verts[face[(j2 + 2) % face.length]], v2);
                    xj.vadd(v1, v1);
                    ...
                    if (dot > 0 && dot * dot < edge.lengthSquared() && xi_to_p.lengthSquared() < R * R) {
                        ...
                        p.vsub(xi, r2.ni);
                        r2.ni.normalize();
                        r2.ni.scale(R, r2.ri); // Should be relative to the body.
                        r2.rj.vadd(xj, r2.rj);
                        r2.rj.vsub(bj.position, r2.rj); // Should be relative to the body.
                        r2.ri.vadd(xi, r2.ri);
                        r2.ri.vsub(bi.position, r2.ri);
                        this.result.push(r2);
                        this.createFrictionEquationsFromContact(r2, this.frictionResult); // Release world vertices
                        for(let j3 = 0, Nfaceverts1 = faceVerts.length; j3 !== Nfaceverts1; j3++)v3pool.release(faceVerts[j3]);
                        v3pool.release(v1);
                        v3pool.release(v2);
                        v3pool.release(p);
                ...
                for(let j4 = 0, Nfaceverts2 = faceVerts.length; j4 !== Nfaceverts2; j4++)v3pool.release(faceVerts[j4]);
            }
        }
    }
    ...
    sphereTrimesh(sphereShape, trimeshShape, spherePos, trimeshPos, sphereQuat, trimeshQuat, sphereBody, trimeshBody, rsi, rsj, justTest) {
        ...
        for(let i = 0; i < triangles.length; i++)for(let j = 0; j < 3; j++){
         ...
         // Check all edges
        for(let i1 = 0; i1 < triangles.length; i1++)for(let j1 = 0; j1 < 3; j1++){
            trimeshShape.getVertex(trimeshShape.indices[triangles[i1] * 3 + j1], edgeVertexA);
            trimeshShape.getVertex(trimeshShape.indices[triangles[i1] * 3 + (j1 + 1) % 3], edgeVertexB);
            ...
            if (positionAlongEdgeA > 0 && positionAlongEdgeB < 0) {
                ...
                if (dist < sphereShape.radius) {
                    if (justTest) return true;
                    const r1 = this.createContactEquation(sphereBody, trimeshBody, sphereShape, trimeshShape, rsi, rsj);
                    tmp.vsub(localSpherePos, r1.ni);
                    r1.ni.normalize();
                    r1.ni.scale(sphereShape.radius, r1.ri);
                    r1.ri.vadd(spherePos, r1.ri);
                    r1.ri.vsub(sphereBody.position, r1.ri);
                    Transform.pointToWorldFrame(trimeshPos, trimeshQuat, tmp, tmp);
                    tmp.vsub(trimeshBody.position, r1.rj);
                    Transform.vectorToWorldFrame(trimeshQuat, r1.ni, r1.ni);
                    Transform.vectorToWorldFrame(trimeshQuat, r1.ri, r1.ri);
                    this.result.push(r1);
                    this.createFrictionEquationsFromContact(r1, this.frictionResult);
                }
            }
...
function pointInPolygon(verts, normal, p) {
    ...
    for(let i = 0; i !== N; i++){
        ...
        if (positiveResult === null || r > 0 && positiveResult === true || r <= 0 && positiveResult === false) {
            ...
            continue;
        } else return false; // Encountered some other sign. Exit.
    } // If we got here, all dot products were of the same sign.
    return true;
}
...
class OverlapKeeper {
   ...
   */ set(i, j) {
        ...
        if (key === current[index]) return; // Pair was already added
        for(let j1 = current.length - 1; j1 >= index; j1--)current[j1 + 1] = current[j1];
        current[index] = key;
    }
    /**
   * tick
   ...
   */ getDiff(additions, removals) {
        ...
        j = 0;
        for(let i1 = 0; i1 < bl; i1++){
            let found1 = false;
            const keyB = b[i1];
            while(keyB > a[j])j++;
            found1 = a[j] === keyB;
            if (!found1) unpackAndPush(removals, keyB);
        }
    }
}
 ...
 */ class World extends EventTarget {
   ...
   */ fixedStep(dt, maxSubSteps) {
        ...
        if (!this.lastCallTime) this.step(dt, undefined, maxSubSteps);
        else {
   ...
   */ step(dt, timeSinceLastCalled, maxSubSteps) {
        ...
        if (timeSinceLastCalled === undefined) {
            ...
            while(this.accumulator >= dt && substeps < maxSubSteps){
                ...
                this.accumulator -= dt;
                substeps++;
                if (performance.now() - t0 > dt * 1000) break;
    ...
    internalStep(dt) {
        ...
        for(let i1 = 0, Nsubsystems = this.subsystems.length; i1 !== Nsubsystems; i1++)this.subsystems[i1].update();
         // Collision detection
        if (doProfiling) profilingStart = performance.now();
        ...
        for(let k = 0; k !== ncontacts; k++){
            // Current contact
            const c1 = contacts[k]; // Get current collision indeces
            const bi1 = c1.bi;
            const bj = c1.bj;
            const si = c1.si;
            const sj = c1.sj; // Get collision properties
            let cm;
            if (bi1.material && bj.material) cm = this.getContactMaterial(bi1.material, bj.material) || this.defaultContactMaterial;
            else cm = this.defaultContactMaterial;
             // c.enabled = bi.collisionResponse && bj.collisionResponse && si.collisionResponse && sj.collisionResponse;
            cm.friction; // c.restitution = cm.restitution;
            // If friction or restitution were specified in the material, use them
            if (bi1.material && bj.material) {
                if (bi1.material.friction >= 0 && bj.material.friction >= 0) bi1.material.friction, bj.material.friction;
                if (bi1.material.restitution >= 0 && bj.material.restitution >= 0) c1.restitution = bi1.material.restitution * bj.material.restitution;
            } // c.setSpookParams(
            //           cm.contactEquationStiffness,
            //           cm.contactEquationRelaxation,
            //           dt
            //       );
            solver.addEquation(c1); // // Add friction constraint equation
            // if(mu > 0){
            // 	// Create 2 tangent equations
            // 	const mug = mu * gnorm;
            ...
            // }
            if (bi1.allowSleep && bi1.type === Body.DYNAMIC && bi1.sleepState === Body.SLEEPING && bj.sleepState === Body.AWAKE && bj.type !== Body.STATIC) {
                const speedSquaredB = bj.velocity.lengthSquared() + bj.angularVelocity.lengthSquared();
                const speedLimitSquaredB = bj.sleepSpeedLimit ** 2;
                if (speedSquaredB >= speedLimitSquaredB * 2) bi1.wakeUpAfterNarrowphase = true;
            }
            if (bj.allowSleep && bj.type === Body.DYNAMIC && bj.sleepState === Body.SLEEPING && bi1.sleepState === Body.AWAKE && bi1.type !== Body.STATIC) {
                const speedSquaredA = bi1.velocity.lengthSquared() + bi1.angularVelocity.lengthSquared();
                const speedLimitSquaredA = bi1.sleepSpeedLimit ** 2;
                if (speedSquaredA >= speedLimitSquaredA * 2) bj.wakeUpAfterNarrowphase = true;
            } // Now we know that i and j are in contact. Set collision matrix state
            this.collisionMatrix.set(bi1, bj, true);
            if (!this.collisionMatrixPrevious.get(bi1, bj)) {
                // First contact!
                // We reuse the collideEvent object, otherwise we will end up creating new objects for each new contact, even if there's no event listener attached.
                World_step_collideEvent.body = bj;
                World_step_collideEvent.contact = c1;
                bi1.dispatchEvent(World_step_collideEvent);
                World_step_collideEvent.body = bi1;
                bj.dispatchEvent(World_step_collideEvent);
            }
            this.bodyOverlapKeeper.set(bi1.id, bj.id);
        ...
        for(i = 0; i !== N; i++){
            const bi2 = bodies[i];
            if (bi2.wakeUpAfterNarrowphase) {
                bi2.wakeUp();
                bi2.wakeUpAfterNarrowphase = false;
            }
        ...
        for(i = 0; i !== Nconstraints; i++){
            ...
            c2.update();
            for(let j1 = 0, Neq = c2.equations.length; j1 !== Neq; j1++){
                const eq = c2.equations[j1];
        ...
        for(i = 0; i !== N; i++){
            ...
            if (bi3.type & DYNAMIC) {
                // Only for dynamic bodies
                const ld = pow(1.0 - bi3.linearDamping, dt);
                const v = bi3.velocity;
                v.scale(ld, v);
                const av = bi3.angularVelocity;
                if (av) {
                    const ad = pow(1.0 - bi3.angularDamping, dt);
                    av.scale(ad, av);
                }
            }
        }
        ...
        if (this.allowSleep) {
            ...
            for(i = 0; i !== N; i++){
                const bi4 = bodies[i];
                bi4.sleepTick(this.time);
                if (bi4.sleepState !== Body.SLEEPING) hasActiveBodies = true;
            }
        }
    ...
    emitContactEvents() {
        ...
        if (hasEndContact) {
            for(let i1 = 0, l1 = removals.length; i1 < l1; i1 += 2){
                endContactEvent.bodyA = this.getBodyById(removals[i1]);
                endContactEvent.bodyB = this.getBodyById(removals[i1 + 1]);
        ...
        if (hasEndShapeContact) {
            for(let i3 = 0, l3 = removals.length; i3 < l3; i3 += 2){
                const shapeA1 = this.getShapeById(removals[i3]);
                const shapeB1 = this.getShapeById(removals[i3 + 1]);
                endShapeContactEvent.shapeA = shapeA1;
                endShapeContactEvent.shapeB = shapeB1;
                if (shapeA1) endShapeContactEvent.bodyA = shapeA1.body;
                if (shapeB1) endShapeContactEvent.bodyB = shapeB1.body;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["jKCYL","kCSc6"], "kCSc6", "parcelRequire9b34")

//# sourceMappingURL=index.bbbbfc18.js.map
